...
class Interceptor extends \Magento\Swatches\Block\LayeredNavigation\RenderLayered implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getSwatchData()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getSwatchData', func_get_args(), $pluginInfo) : parent::getSwatchData();
    }
    ...
    public function getSwatchPath($type, $filename)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getSwatchPath', func_get_args(), $pluginInfo) : parent::getSwatchPath($type, $filename);
    }
